...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        msg = input("please enter a line of text and press <Enter>: ")
        stamp = rospy.get_time()
        print_string = "Message: " +str(msg) + " Time: " +str(stamp) 
  
        
        # Publish our string to the 'chatter_talk' topic
        pub.publish(msg, stamp)
        print(rospy.get_name() + ": I sent \"%s\"" % print_string)
